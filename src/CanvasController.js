...
export default class CanvasController {
  ...
  init(dataSet) {
    ...
    window.addEventListener("resize", event => {
      ...
      this.genotypeCanvas.width = canvasHolder.getBoundingClientRect().width;
      this.overviewCanvas.width = canvasHolder.getBoundingClientRect().width;
      this.genotypeCanvas.backBuffer.width = canvasHolder.getBoundingClientRect().width;
      this.overviewCanvas.backBuffer.width = canvasHolder.getBoundingClientRect().width;
      this.genotypeCanvas.canvas.width = canvasHolder.getBoundingClientRect().width;
      this.overviewCanvas.canvas.width = canvasHolder.getBoundingClientRect().width;
      this.genotypeCanvas.height = ((window.innerHeight - settings.clientHeight - resizehandle.clientHeight) * 2 / 3 - 10);
      this.overviewCanvas.height = ((window.innerHeight - settings.clientHeight - resizehandle.clientHeight) / 3 - 10);
      this.genotypeCanvas.backBuffer.height = ((window.innerHeight - settings.clientHeight - resizehandle.clientHeight) * 2 / 3 - 10);
      this.overviewCanvas.height = ((window.innerHeight - settings.clientHeight - resizehandle.clientHeight) / 3 - 10);
      this.genotypeCanvas.canvas.height = ((window.innerHeight - settings.clientHeight - resizehandle.clientHeight) * 2 / 3 - 10);
      this.overviewCanvas.canvas.height = ((window.innerHeight - settings.clientHeight - resizehandle.clientHeight) / 3 - 10);
      this.genotypeCanvas.verticalScrollbar = new ScrollBar(this.genotypeCanvas.canvas.getBoundingClientRect().right - this.genotypeCanvas.scrollbarWidth + 2, this.genotypeCanvas.alleleCanvasHeight() + this.genotypeCanvas.scrollbarHeight, this.genotypeCanvas.scrollbarWidth, this.genotypeCanvas.alleleCanvasHeight(), true);
